...
public class InventoryConfigs {
    public static Screen build(Screen parent){
        ...
        builder.addWidget(new CategoryBox(Component.translatable("kelui-sounds.config.category.inventory.slot_clicked"))
                ...
                .addValue(new SliderBuilder(Component.translatable("kelui-sounds.config.pitch")).setDefaultValue(SoundStorage.getSound("inventory.slot_clicked").defaultPitch).setMin(0.1F).setMax(2.0F).setConfig(KelUISounds.config, SoundStorage.getSound("inventory.slot_clicked").getConfigPitch()).build())
                .addValue(new SliderBuilder(Component.translatable("kelui-sounds.config.volume")).setDefaultValue(SoundStorage.getSound("inventory.slot_clicked").defaultVolume).setMin(0.1F).setMax(2.0F).setConfig(KelUISounds.config, SoundStorage.getSound("inventory.slot_clicked").getConfigVolume()).build()));
        ...
        builder.addWidget(new CategoryBox(Component.translatable("kelui-sounds.config.category.inventory.swap_paint"))
                ...
                .addValue(new SliderBuilder(Component.translatable("kelui-sounds.config.pitch")).setDefaultValue(SoundStorage.getSound("inventory.swap_paint").defaultPitch).setMin(0.1F).setMax(2.0F).setConfig(KelUISounds.config, SoundStorage.getSound("inventory.swap_paint").getConfigPitch()).build())
                .addValue(new SliderBuilder(Component.translatable("kelui-sounds.config.volume")).setDefaultValue(SoundStorage.getSound("inventory.swap_paint").defaultVolume).setMin(0.1F).setMax(2.0F).setConfig(KelUISounds.config, SoundStorage.getSound("inventory.swap_paint").getConfigVolume()).build()));
        ...
        builder.addWidget(new CategoryBox(Component.translatable("kelui-sounds.config.category.inventory.drop"))
                ...
                .addValue(new SliderBuilder(Component.translatable("kelui-sounds.config.pitch")).setDefaultValue(SoundStorage.getSound("inventory.drop").defaultPitch).setMin(0.1F).setMax(2.0F).setConfig(KelUISounds.config, SoundStorage.getSound("inventory.drop").getConfigPitch()).build())
                .addValue(new SliderBuilder(Component.translatable("kelui-sounds.config.volume")).setDefaultValue(SoundStorage.getSound("inventory.drop").defaultVolume).setMin(0.1F).setMax(2.0F).setConfig(KelUISounds.config, SoundStorage.getSound("inventory.drop").getConfigVolume()).build()));
